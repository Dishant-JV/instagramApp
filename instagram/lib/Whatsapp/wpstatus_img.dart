...
class WpStatusImg extends StatefulWidget {
  ...
  final String? time;
  final String? img;
  const WpStatusImg({Key? key, this.name, this.time, this.img}) : super(key: key);
  ...
  void download(){
     timer=Timer.periodic(Duration(milliseconds: 1), (timer){
      if(value<1){
        ...
        timer.cancel();
        Navigator.pop(context,MaterialPageRoute(builder: (context)=>WpStatus()));
      }
    });
  }
  @override
        ...
        body: Column(
          children: [
            ...
            Container(
              ...
              height: 300,
              child: Image.asset(widget.img.toString(),fit: BoxFit.cover,),
            )
          ],
        ),
      ),
