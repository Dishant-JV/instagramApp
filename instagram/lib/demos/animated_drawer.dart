...
class Animatedrawers extends StatefulWidget {
  const Animatedrawers({Key? key}) : super(key: key);

  @override
  _AnimatedrawersState createState() => _AnimatedrawersState();
}

class _AnimatedrawersState extends State<Animatedrawers> {
  @override
